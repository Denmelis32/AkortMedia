...
class _NewsCardState extends State<NewsCard> {
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  Wrap(
                    spacing: 8,
                    children: [
                      _buildColorOption(const Color(0xFFDA291C), 'Красный', setState),
                      _buildColorOption(const Color(0xFF6C1D45), 'Фиолетовый', setState),
                      _buildColorOption(const Color(0xFFFFD700), 'Золотой', setState),
                      _buildColorOption(widget.primaryColor, 'Основной', setState),
              ...
              actions: [
                TextButton(
                  ...
                  child: Text('Отмена', style: TextStyle(color: widget.secondaryTextColor)),
                ),
                ElevatedButton(
                  onPressed: () {
                    if (_tagEditController.text.trim().isNotEmpty) {
                      widget.onTagEdit(_editingTagId, _tagEditController.text.trim(), _selectedTagColor);
                      Navigator.pop(context);
                    }
                  },
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: _selectedTagColor == color ? Colors.black : Colors.transparent,
            width: 2,
          ),
        ),
        child: Text(
  ...
  Widget build(BuildContext context) {
    ...
    final userTags = widget.news['user_tags'] is Map
        ? (widget.news['user_tags'] as Map).map((key, value) => MapEntry(key.toString(), value.toString()))
                    ...
                    child: Row(
                      children: [
                        ...
                        if (userTags.isNotEmpty && userTags.values.first.isNotEmpty)
                          Padding(
                            padding: const EdgeInsets.only(right: 8), // Компактный отступ
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                    if (_getTagIcon(userTags.values.first, tagColor) != null) ...[
                                      _getTagIcon(userTags.values.first, tagColor)!,
